jQuery(document).ready(function($)
{
    ...
    $("#vc_post-custom-css").val(cleverMenuItem.style);
    ...
    if (typeof vc !== 'undefined') {
        ...
        if (self !== parentWindow) {
            ...
            if (typeof parentWindow.clever_menu_editing !== 'undefined' &&  parentWindow.clever_menu_editing === 'customize') {
                $('.vc_btn-sm', saveItemList).html(cleverMenuI18n.save);
            }
            ...
            function clever_menu_save_item_settings()
            {
                ...
                if (typeof parentWindow.clever_menu_editing !== undefined &&  parentWindow.clever_menu_editing === 'customize') {
                    ...
                    settingValue['clever_menu_data'] = _data;
                    parentWindow.vc_current_control.setting.set(settingValue);
                    if (_data.enable === "1") {
                        parentWindow.vc_current_control.container.addClass('clever-mega-menu-item-mega-enabled');
                    } else {
                        parentWindow.vc_current_control.container.removeClass('clever-mega-menu-item-mega-enabled');
                    }
                    parentWindow.vc_current_item_panel.addClass('clever-mega-menu-customize-hide-vc');
