			...
			<div class="welcome-panel-content">
                ...
                <div class="welcome-panel-column-container">
                    <div class="welcome-panel-column">
                        ...
                        <p class="hide-if-no-customize"><?php esc_html_e('or', 'clever-mega-menu') ?>, <a href="<?php echo admin_url('nav-menus.php') ?>"><?php esc_html_e('edit an existing navigation menu', 'clever-mega-menu') ?></a>.</p>
                    </div>
                    <div class="welcome-panel-column">
                        ...
                        <ul>
                            ...
                            <li><i class="dashicons dashicons-plus-alt"></i> <a href="<?php echo admin_url('post-new.php?post_type=clever_menu_location') ?>"><?php esc_html_e('Register a menu location', 'clever-mega-menu') ?></a></li>
                    ...
                    <div class="welcome-panel-column welcome-panel-last">
                        ...
                        <ul>
							...
							<li><i class="dashicons dashicons-sos"></i> <a target="_blank" href="http://member.zootemplate.com/helpdesk/"><?php esc_html_e('Get help at plugin helpdesk', 'clever-mega-menu') ?></a></li>
                            ...
                            <div class="inside">
                                <div class="main">
                                    <?php
                                        ...
                                        $locations_count = wp_count_posts('clever_menu_location');
                                        $location_text = ($locations_count->publish > 1) ? esc_html__('Menu Locations', 'clever-mega-menu') : esc_html__('Menu Location', 'clever-mega-menu');
                                    ?>
                                    <ul>
                                        ...
                                        <li><i class="dashicons dashicons-menu"></i> <a href="<?php echo admin_url('edit.php?post_type=clever_menu_location') ?>"><?php echo $locations_count->publish . ' ' . esc_html__('Published', 'clever-mega-menu') . ' ' . $location_text ?></a></li>
                                    </ul>
