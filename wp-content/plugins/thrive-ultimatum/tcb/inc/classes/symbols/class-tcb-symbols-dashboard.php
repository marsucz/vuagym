...
class TCB_Symbols_Dashboard {
	...
	public function admin_symbols_feature( $features ) {
		$features['symbols_manager'] = array(
			...
			'title'       => __( 'Templates & Symbols', 'thrive-cb' ),
			'description' => __( 'Save time designing pages by using templates and symbols. Manage these saved elements from a single dashboard.', 'thrive-cb' ),
			'btn_link'    => add_query_arg( 'page', $this->_tcb_admin_dashboard . '#templatessymbols', admin_url( 'admin.php' ) ),
			'btn_text'    => __( 'Manage Saved Elements', 'thrive-cb' ),
		);
	...
	public function admin_menu() {
		add_submenu_page( null, __( 'Symbols', 'thrive-cb' ), __( 'Symbols', 'thrive-cb' ), 'manage_options', $this->_symbols_dashboard_page, array(
			$this,
