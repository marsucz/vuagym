...
if ( ! empty( $available_variations ) ) : ?>
	...
	<div class="variations_form cart in_loop" data-product_id="<?php echo $product->get_id(); ?>" data-product_variations="<?php echo esc_attr( json_encode( $available_variations ) ) ?>">
