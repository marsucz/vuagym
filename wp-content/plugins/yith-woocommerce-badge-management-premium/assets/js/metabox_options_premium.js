jQuery( function ( $ ) {
    var type                         = $( '#yith-wcbm-badge-type' ).data( 'type' ),
        ...
        positioning_render           = function () {
            ...
            if ( p_top.substr( 0, 8 ) == 'calc(50%' ) {
                p_top = 'calc(50% - ' + preview_badge.height() / 2 + 'px)';
                pos_top.val( p_top );
            }

            if ( p_left.substr( 0, 8 ) == 'calc(50%' ) {
                p_left = 'calc(50% - ' + preview_badge.width() / 2 + 'px)';
                pos_left.val( p_left );
            }
            ...
            var flip_text = '';
            flip_text += flip_text_horizontally.is( ':checked' ) ? ' rotateY(180deg)' : '';
            flip_text += flip_text_vertically.is( ':checked' ) ? ' rotateX(180deg)' : '';
            ...
            switch ( type ) {
                ...
                default:
                    ...
                    preview_badge.css( {
                                           ...
                                           "width"                     : input_width.val() + "px",
                                           "height"                    : input_height.val() + "px",
                    ...
                    if ( line_height != -1 ) {
                        ...
                        preview_badge.css( "line-height", input_height.val() + "px" );
                    }
            }
        },
    ...
    preview_badge.draggable( {
                                 ...
                                 stop       : function () {
                                     var offset = $( this ).position(),
                                         ...
                                         width  = preview_badge.width(),
                                         height = preview_badge.height();
    ...
    pos_top_center.on( 'click', function () {
        pos_top.val( '0' );
        pos_bottom.val( 'auto' );
        pos_left.val( 'calc(50% - ' + preview_badge.width() / 2 + 'px)' );
        pos_right.val( 'auto' );
        preview_render();
    } );
    ...
    pos_left_center.on( 'click', function () {
        pos_top.val( 'calc(50% - ' + preview_badge.height() / 2 + 'px)' );
        pos_bottom.val( 'auto' );
        pos_left.val( '0' );
        pos_right.val( 'auto' );
        preview_render();
