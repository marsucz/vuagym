...
if ( $flip_text_horizontally )
    echo ".yith-wcbm-on-sale-badge$id_advanced_badge .yith-wcbm-badge-text-advanced{-ms-transform: rotateY(180deg); -webkit-transform: rotateY(180deg); transform:rotateY(180deg)}";

if ( $flip_text_vertically )
    echo ".yith-wcbm-on-sale-badge$id_advanced_badge .yith-wcbm-badge-text-advanced *{-ms-transform: rotateX(180deg); -webkit-transform: rotateX(180deg); transform:rotateX(180deg)}";
...
switch ( $id_badge_style ) {
    ...
    case '4':
        ...
        if ( $flip_text_horizontally )
            echo ".yith-wcbm-on-sale-badge$id_advanced_badge .yith-wcbm-badge-text-advanced{-ms-transform: rotateZ(90deg) rotateY(180deg); -webkit-transform: rotateZ(90deg) rotateY(180deg); transform:rotateZ(90deg) rotateY(180deg)}";
        ...
        <?php
        if ( !$flip_text_vertically )
            echo "-webkit-transform: rotate(45deg); -ms-transform: rotate(45deg); transform: rotate(45deg);";
        else
            echo "-webkit-transform: rotateX(180deg) rotateZ(-45deg); -ms-transform: rotateX(180deg) rotateZ(-45deg); transform: rotateX(180deg) rotateZ(-45deg);";
        ?>
