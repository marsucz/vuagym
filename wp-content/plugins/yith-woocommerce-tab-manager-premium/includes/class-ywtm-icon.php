...
if ( ! class_exists( 'YWTM_Icon' ) ) {
    ...
    class YWTM_Icon
    {
        ...
        public function __construct()
        {
            ...
            $this->_icon_font_folder_url = YWTM_ASSETS_URL . 'fonts';
            $this->_icon_font_folder_path = YWTM_ASSETS_PATH . 'fonts';
        ...
        public function enqueue_styles()
        {
            ...
            if( !class_exists( 'YIT_Asset' ) ) {
                ...
                $css_prefix = is_admin() ? 'yit-' : 'ywtm-';

                wp_enqueue_style( $css_prefix . 'font-awesome', YWTM_ASSETS_URL . 'css/font-awesome.min.css' );
            }
        ...
        function icon_list_hook( $icon_list )
        {
            ...
            $subject = file_get_contents( YWTM_DIR . 'assets/css/font-awesome.css' );
    ...
    /**
     * Return the instance of YWTM_Icon class
     *
     * @return \YWTM_Icon
     * @since    2.0.0
     * @author   Emanuela Castorina <emanuela.castorina@yithemes.com>
