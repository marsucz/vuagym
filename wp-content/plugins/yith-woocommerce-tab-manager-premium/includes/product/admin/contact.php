...
$contact_info = get_post_meta($post->ID, $tab."_custom_form", true);
if ( !$contact_info )
    $contact_info   =   array();
    ...
    <div class="custom_tab_options">
        <div class="options_group">
            <p class="form-field">
                ...
                <input type="checkbox" id="field_name" class="add_field_check" name="<?php echo $tab?>_name_show" <?php checked($fields['name']['show'],'on');?> />
                <p class="sub_form_video_row form-field" id="field_name_req" style="<?php echo $show_req_name?>">
                    <label class="req">Required</label>
                    <input type="checkbox" name="<?php echo $tab?>_name_req" <?php checked($fields['name']['req'],'on');?>/>
            ...
            <p class="form-field">
                ...
                <input type="checkbox"  id="field_webaddr" class="add_field_check" name="<?php echo $tab?>_webaddr_show" <?php checked($fields['webaddr']['show'],'on');?>/>
                <p class="sub_form_video_row form-field" id="field_webaddr_req" style="<?php echo $show_req_webaddr?>">
                    <label class="req">Required</label>
                    <input type="checkbox"  name="<?php echo $tab?>_webaddr_req"  <?php checked($fields['webaddr']['req'],'on');?>/>
            ...
            <p class="form-field">
                ...
                <input type="checkbox"  id="field_subj" class="add_field_check" name="<?php echo $tab?>_subj_show" <?php checked($fields['subj']['show'],'on');?>/>
                <p class="sub_form_video_row form-field" id="field_subj_req" style="<?php echo $show_req_subj?>">
                    <label class="req">Required</label>
                    <input type="checkbox"  name="<?php echo $tab?>_subj_req" <?php checked($fields['subj']['req'],'on');?>/>
                    <span class="description"><?php _e( 'Check this option to make it required.', 'yith-woocommerce-tab-manager' ) ?></span>
                </p>
            </p>
        </div>
