...
<tr>
    ...
    <td class="file_desc"><input type="text" class="input_text" placeholder="<?php _e('Insert a short description of the file', 'yith-woocommerce-tab-manager');?>" name="<?php echo $field_name.'[file_desc][]'?>" value="<?php echo esc_attr( $file['desc'] ); ?>" /></td>
	<td class="file_url"><input type="text" class="input_text" placeholder="<?php _e( "http://", 'yith-woocommerce-tab-manager' ); ?>" name="<?php echo $field_name.'[file_urls][]'?>" value="<?php echo esc_attr( $file['file'] ); ?>" /></td>
