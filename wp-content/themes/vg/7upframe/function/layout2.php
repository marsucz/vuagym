							...
							<div class="row product-header">
								...
								<div class="col-md-7 col-sm-12 col-xs-12">
									<div class="detail-info">
										<h2 class="title-detail" style="color: #202020; font-size: 30px; border-left: 7px solid #ddd; padding: 0 0 0 .3em!important;">'.get_the_title().'</h2>
						...
						<div class="col-md-8 col-sm-7 col-xs-12 col-md-pull-4 col-sm-pull-5">
							<div class="mobileHide">
								<div class="row product-header">
									...
									<div class="col-md-7 col-sm-12 col-xs-12">
										<div class="detail-info">
											<h2 class="title-detail" style="color: #202020; font-size: 30px; border-left: 7px solid #fc6721; padding: 0 0 0 .3em!important;">'.get_the_title().'</h2>
											<a href="#reviews">'.s7upf_get_rating_html().'</a>
											<div class="row" style="margin: 15px 0px 10px 0px;">
												<span class="genuine">Đảm bảo chính hãng</span>'.$nha_san_xuat.'
											</div>
