...
(function($) {
    ...
    $(document).ready(function() {
        ...
        $('body').on('click','.sv-button-add-slider',function(){
            ...
            item += '<label style="margin-top:10px; margin-bottom: 10px; display: block; ">Title</label>';
            item += '<input class="widefat" name="'+idname+'['+key+'][title]" value="" type="text">';
            item += '<label style="margin-top:10px; margin-bottom: 10px; display: block; ">Description</label>';
            item += '<input class="widefat" name="'+idname+'['+key+'][des]" value="" type="text">';
